        ...
        <form className="flex flex-col mt-8">
          ...
          <div className="mt-1">
            {method === "email" ? (
              <input
                type="email"
                className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 foucs:border-orange-500"
                required
              />
            ) : null}
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input
                  type="number"
                  className="py-2 px-4 border border-transparent appearance-none w-full border-gray-300 rounded-md rounded-l-none shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 foucs:border-orange-500"
                  required
                />
              </div>
            ) : null}
